...
def get_data(input_path):
    ...
    with open(input_path, 'r') as f:
        ...
        for line in f:
            ...
            filename = '/content/drive/MyDrive/Colab Notebooks/ASS3/Images/' + filename
...
def class_loss_regr(num_classes):
    ...
    def class_loss_regr_fixed_num(y_true, y_pred):
        ...
        devided = K.sum(
            K.cast(y_true[:, :, :indice_slice], 'float32') * (x_bool * (0.5 * x * x) + (1 - x_bool) * (x_abs - 0.5)))
...
base_path = '/content/drive/MyDrive/Colab Notebooks/ASS3/'

train_path = '/content/drive/MyDrive/Colab Notebooks/ASS3/annotation.txt'  # Training data (annotation file)
